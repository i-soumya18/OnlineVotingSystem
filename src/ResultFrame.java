...
public class ResultFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        // Set initial text to display while data is being fetched
        jLabel12.setText("...");
        jLabel13.setText("...");
        jLabel14.setText("...");
        jLabel15.setText("...");
    ...
    private void displayResults() {
        try {
            ...
            // Retrieve the option with the maximum votes
            ...
            JOptionPane.showMessageDialog(this, "Error retrieving results: " + ex.getMessage());
        }
    }
